...
extract_regression_results <- function(regression_output, outcome_labels, age) {
  result_df <- map2_dfr(outcome_labels, regression_output, function(outcome, model_list) {
    map_dfr(model_list, ~ tidy(.x)[c("term", "estimate", "p.value")][2, ]) %>%
...
exposure_vars <- c("pm25_age7_std", "bc_age7_std", "no2_age7_std")
...
exposure_vars <- c("pm25_age9_std", "bc_age9_std", "no2_age9_std")
...
exposure_vars <- c("pm25_age15_std", "bc_age15_std", "no2_age15_std")
...
exposure_vars <- c("pm25_age18_std", "bc_age18_std", "no2_age18_std")
...
exposure_vars <- c("pm25_age24_std", "bc_age24_std", "no2_age24_std")
...
all_models <- result_df_7 %>% 
  ...
  select(time_point, Outcome, term, estimate, estimate_bt, p.value)

saveRDS(all_models, paste0(results, "all_models.rds"))
...
# Plots
residual_plots(df_age_7, result_7[[1]][[1]], Gp_F7_log, pm25_age7_std)
```
...
# Plots
residual_plots(df_age_7, result_7[[1]][[2]], Gp_F7_log, bc_age7_std)
```
...
# Plots
residual_plots(df_age_7, result_7[[1]][[3]], Gp_F7_log, no2_age7_std)
```
...
# Plots
residual_plots(df_age_9, result_9[[1]][[1]], CRP_f9_log, pm25_age9_std)
```
...
# Plots
residual_plots(df_age_9, result_9[[1]][[2]], CRP_f9_log, bc_age9_std)
```
...
# Plots
residual_plots(df_age_9, result_9[[1]][[3]], CRP_f9_log, no2_age9_std)
```
...
# Plots
residual_plots(df_age_9, result_9[[2]][[1]], IL6_pgml_f9_log, pm25_age9_std)
```
...
# Plots
residual_plots(df_age_9, result_9[[2]][[2]], IL6_pgml_f9_log, bc_age9_std)
```
...
# Plots
residual_plots(df_age_9, result_9[[2]][[3]], IL6_pgml_f9_log, no2_age9_std)
```
...
# Plots
residual_plots(df_age_15, result_15[[1]][[1]], Gp_TF3_log, pm25_age15_std)
```
...
# Plots
residual_plots(df_age_15, result_15[[1]][[2]], Gp_TF3_log, bc_age15_std)
```
...
# Plots
residual_plots(df_age_15, result_15[[1]][[3]], Gp_TF3_log, no2_age15_std)
```
...
# Plots
residual_plots(df_age_15, result_15[[2]][[1]], crp_TF3_log, pm25_age15_std)
```
...
# Plots
residual_plots(df_age_15, result_15[[2]][[2]], crp_TF3_log, bc_age15_std)
```
...
# Plots
residual_plots(df_age_15, result_15[[2]][[3]], crp_TF3_log, no2_age15_std)
```
...
# Plots
residual_plots(df_age_18, result_18[[1]][[1]], Gp_TF4_log, pm25_age18_std)
```
...
# Plots
residual_plots(df_age_18, result_18[[1]][[2]], Gp_TF4_log, bc_age18_std)
```
...
# Plots
residual_plots(df_age_18, result_18[[1]][[3]], Gp_TF4_log, no2_age18_std)
```
...
# Plots
residual_plots(df_age_18, result_18[[2]][[1]], CRP_TF4_log, pm25_age18_std)
```
...
# Plots
residual_plots(df_age_18, result_18[[2]][[2]], CRP_TF4_log, bc_age18_std)
```
...
# Plots
residual_plots(df_age_18, result_18[[2]][[3]], CRP_TF4_log, no2_age18_std)
```
...
# Plots
residual_plots(df_age_24, result_24[[1]][[1]], Gp_F24_log, pm25_age24_std)
```
...
# Plots
residual_plots(df_age_24, result_24[[1]][[2]], Gp_F24_log, bc_age24_std)
```
...
# Plots
residual_plots(df_age_24, result_24[[1]][[3]], Gp_F24_log, no2_age24_std)
```
...
# Plots
residual_plots(df_age_24, result_24[[2]][[1]], CRP_F24_log, pm25_age24_std)
```
...
# Plots
residual_plots(df_age_24, result_24[[2]][[2]], CRP_F24_log, bc_age24_std)
```
...
# Plots
residual_plots(df_age_24, result_24[[2]][[3]], CRP_F24_log, no2_age24_std)
```